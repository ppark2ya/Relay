  ...
  return (
    <div className="flex-1 flex flex-col bg-white dark:bg-gray-800 overflow-hidden">
      ...
      <div className="flex items-center gap-4 px-4 py-2 border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900">
        ...
        {isCss && (
          <span className="text-xs px-2 py-0.5 bg-gray-200 dark:bg-gray-600 text-gray-700 dark:text-gray-200 rounded">CSS</span>
        )}
      ...
      <div className="flex-1 overflow-auto p-4">
        {activeTab === 'body' && (() => {
          ...
          if (isJson || isXml || isHtml || isCss) {
            const lang = isJson ? 'json' : isXml ? 'xml' : isHtml ? 'html' : 'css';
            return (
              <CodeEditor
