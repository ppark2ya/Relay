                              ...
                              <FormField label={
                                <span className="flex items-center gap-1">
                                  ...
                                  <span className="relative group/extract">
                                    ...
                                    <span className="absolute bottom-full left-1/2 -translate-x-1/2 mb-1.5 hidden group-hover/extract:block w-64 px-3 py-2 text-xs text-gray-100 bg-gray-800 dark:bg-gray-700 rounded-md shadow-lg z-50 font-normal leading-relaxed">
                              ...
                              <FormField label={
                                <span className="flex items-center gap-1">
                                  ...
                                  <span className="relative group/condition">
                                    ...
                                    <span className="absolute bottom-full left-1/2 -translate-x-1/2 mb-1.5 hidden group-hover/condition:block w-64 px-3 py-2 text-xs text-gray-100 bg-gray-800 dark:bg-gray-700 rounded-md shadow-lg z-50 font-normal leading-relaxed">
